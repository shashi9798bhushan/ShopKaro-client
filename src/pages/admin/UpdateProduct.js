          ...
          <div className="col-md-9">
            ...
            <div className="m-1 w-75" >
              ...
              <div>
                ...
                <div className="mb-3">
                 <Select value={shipping?"Yes":"No"} bordered={false} placeholder="Select Shipping" size="large" showSearch className="form-select mb-3" onChange={(value)=>setShipping(value)}>
