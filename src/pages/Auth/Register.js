        ...
        <div className="register form-container ">
            ...
            <h3 className="title">REGISTER FORM</h3>
                ...
                <div className="mb-3">
                    ...
                    <input value={phone} onChange={(e)=>{setPhone(e.target.value)}} type="text" className="form-control" id="exampleInputEmail1" placeholder='Enter Your Phone No.'  required/>
                ...
                <div className="mb-3">
                    ...
                    <input value={answer} onChange={(e)=>{setAnswer(e.target.value)}} type="text" className="form-control" id="exampleInputEmail1"  placeholder="What was Your First School's Name" required/>
